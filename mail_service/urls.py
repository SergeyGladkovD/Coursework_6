...
from mail_service.views import CustomerCreateView, CustomerUpdateView, CustomerListView, CustomerDetailView, \
    ...
    MailingCreateView, MailingListView, MailingDetailView, MailingUpdateView, MailingDeleteView, home_page

app_name = MailServiceConfig.name

urlpatterns = [
    path('create/', CustomerCreateView.as_view(), name='create_customer'),
    path('list/', CustomerListView.as_view(), name='list_customer'),
